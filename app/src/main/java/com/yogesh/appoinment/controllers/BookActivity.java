...
//        loadImage(clientID);
    ...
    public Dialog registrationSuccessDialog() {
        ...
        builder.setMessage("Your appointment added successfully! ")
                .setCancelable(false)
    ...
    private boolean isValid() {
        ...
        if (txtOneWayFrom.getText().toString().equals("")) {
            symptomsAlert().show();
            return false;
        }
    ...
    //show select symptoms


    public Dialog symptomsAlert() {
        return new AlertDialog.Builder(this)
                .setMessage("Please enter symptoms.")
                .setCancelable(false)
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                    }
