 ...
 * Mentesnot Aboset
 * ************************************************************************************************/
package com.yogesh.appoinment.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "BUSTRAVEL";
    ...
    private void updateDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 1) {
            ...
            insertAirline(db, "Air India");
            insertAirline(db, "SpiceJet");
            insertAirline(db, "Jet Airways");
            insertAirline(db, "IndiGo");
            insertAirline(db, "GoAir");
            insertAirline(db, "AirAsia");
            insertAirline(db, "Emirates");
            insertAirline(db, "Vistara");
            insertAirline(db, "Air India");
            insertAirline(db, "SpiceJet");
            insertAirline(db, "Jet Airways");
            ...
            //Pune to Mumbai
            insertFlight(db, "Pune", "Mumbai", "2019-10-15", "2019-10-15", "10:10", "12:10", 200.00, 1);
            insertFlight(db, "Pune", "Mumbai", "2019-10-15", "2019-10-15", "10:10", "12:10", 150.00, 2);
            insertFlight(db, "Pune", "Mumbai", "2019-10-15", "2019-10-15", "11:10", "12:10", 350.00, 3);
            insertFlight(db, "Pune", "Mumbai", "2019-10-15", "2019-10-15", "09:10", "12:10", 250.00, 4);
            insertFlight(db, "Pune", "Mumbai", "2019-10-15", "2019-10-15", "10:10", "12:10", 100.00, 5);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "10:10", "12:10", 120.00, 6);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "09:00", "12:10", 150.00, 7);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "10:10", "12:10", 170.00, 8);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "09:00", "12:10", 140.00, 9);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "09:00", "12:10", 100.00, 10);
            insertFlight(db, "Mumbai", "Pune", "2019-10-16", "2019-10-16", "10:10", "12:10", 350.00, 11);
            insertFlight(db, "Chennai", "Delhi", "2019-10-25", "2019-10-25", "02:00", "04:45", 300.00, 2);
            insertFlight(db, "Chennai", "Delhi", "2019-10-25", "2019-10-25", "01:00", "03:15", 205.00, 1);
            insertFlight(db, "Chennai", "Delhi", "2019-10-25", "2019-10-25", "09:00", "12:20", 350.00, 10);
            insertFlight(db, "Chennai", "Delhi", "2019-10-25", "2019-10-25", "08:00", "10:15", 400.00, 11);
            insertFlight(db, "Chennai", "Delhi", "2019-10-25", "2019-10-25", "11:00", "13:11", 250.00, 1);
            insertFlight(db, "Delhi", "Chennai", "2019-11-15", "2019-11-15", "11:00", "13:11", 300.00, 9);
            insertFlight(db, "Delhi", "Chennai", "2019-11-15", "2019-11-15", "09:00", "12:00", 250.00, 1);
            insertFlight(db, "Delhi", "Chennai", "2019-11-15", "2019-11-15", "08:00", "11:00", 400.00, 3);
            insertFlight(db, "Delhi", "Chennai", "2019-11-15", "2019-11-15", "01:00", "04:00", 150.00, 7);
            insertFlight(db, "Delhi", "Chennai", "2019-11-15", "2019-11-15", "12:00", "14:00", 350.00, 10);
            insertFlight(db, "Kolkata", "Chennai", "2019-10-28", "2019-10-28", "10:10", "12:10", 350.00, 4);
            insertFlight(db, "Goa", "Chennai", "2019-10-16", "2019-10-16", "09:10", "12:10", 185.00, 5);
            insertFlight(db, "Hyderabad", "Shimla", "2019-10-28", "2019-10-28", "11:10", "12:10", 250.00, 6);
            insertFlight(db, "Guwahati", "Shimla", "2019-10-25", "2019-10-25", "10:10", "12:10", 360.00, 7);
            insertFlight(db, "Trichy", "Mumbai", "2019-10-16", "2019-10-16", "10:10", "12:10", 350.00, 8);
            insertFlight(db, "Delhi", "Pune", "2019-10-16", "2019-10-16", "09:10", "12:10", 350.00, 9);
            insertFlight(db, "Shimla", "Goa", "2019-10-28", "2019-10-28", "10:10", "12:10", 350.00, 10);
            ...
            insertClient(db, "Admin", "Admin", "7350456969", "5412547854125963");

            insertAccount(db, "admin@gmail.com", "admin123", 1);
